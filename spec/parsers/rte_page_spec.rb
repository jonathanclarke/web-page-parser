...
describe RtePageParserV1 do
  ...
  describe "when parsing the ryanair article" do
    ...
    it "should parse the content" do
      #"Aer Lingus has issued a statement this morning calling on shareholders to reject Ryanair's offer."
      @pa.content[0].should == "Aer Lingus has issued a statement this morning calling on shareholders to reject Ryanair's offer."
      @pa.content[1].should == "The company will be writing to shareholders in the next 14 days to set out in detail its reasons for rejecting the offer."
      @pa.content[8].should == "Ryanair is seeking acceptance of the bid by 13 September."
